<?php
  ...
  $id = 74;
  $title = '대구시 정책 정보 일람';
  $content = '(수정됨)자세한 정보는 북구청 홈페이지를 참고해주시기 바랍니다.';
  $date = '2022-05-17 07:22:50';
  */

  //echo 'updatePolicy.php가 무사히 열렸습니다.';  //확인용 메세지
  ...
  $rquery = "SELECT * FROM `document_post` WHERE `id`='$id';";
